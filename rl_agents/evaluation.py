...
def evaluate_policy(
    ...
    :return: Mean reward per episode, std of reward per episode, mean discounted reward per episode, std of discounted
        reward per episode. Returns ([float], [int], [float]) when ``return_episode_rewards`` is True
    """
